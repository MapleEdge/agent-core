...
/**
 * Plan is modeled as a visible advisory action because it produces a UI artifact:
 * a user-facing checklist/timeline component. The executor must not consume the
 * plan directly. recommend-next is the only source of executable actions.
 */
