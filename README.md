...
| (built-in) | MemoryProvider | Direct integration | Active — SQLiteHybridMemoryProvider with BM25 + vector hybrid search |
| mem0 | MemoryProvider | Sidecar planned | Superseded by SQLiteHybridMemoryProvider — SQLite LIKE search fallback |
